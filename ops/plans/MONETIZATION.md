...
Siehe auch: [`ops/ROADMAP.md`](../ROADMAP.md) · [`ops/legal/BACKLOG.md`](../legal/BACKLOG.md) L3 · [`ops/finance/SERVICES.md`](../finance/SERVICES.md)
...
| 5 | `ops/finance/COSTS.md` + SERVICES.md aktualisieren |
