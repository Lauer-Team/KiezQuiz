...
| #5 Finance Monthly | CFO | `cfo-finanzen/dashboard.md`, `leitstand.md`, `ops/finance/*`, `reports.md` |
...
Berichte immer nach: `ops/reports/YYYY-MM-DD-<thema>.md`
...
2. Bericht ops/reports/YYYY-MM-DD-backup-archiv.md
...
Bericht ops/reports/YYYY-MM-DD-devops-smoke-check.md
...
3. Bericht ops/reports/YYYY-MM-DD-security-weekly.md
...
Bericht ops/reports/YYYY-MM-DD-seo-weekly.md
...
| **Cron** | `0 7 * * 1` |
| **Agenten-Dateien** | `ops/agents/ceo-kalle/dashboard.md`, `todos.md`, `ops/DEADLINES.md` |
...
1. ops/DEADLINES.md — Status 🔴/🟡 aktualisieren
...
5. ops/LEITSTAND.md Pointer prüfen
...
| **Cron** | `0 8 1 * *` |
| **Agenten-Dateien** | `ops/agents/cfo-finanzen/*`, `ops/finance/SERVICES.md`, `COSTS.md` |
...
1. ops/finance/SERVICES.md + COSTS.md prüfen
2. Supabase MCP: Quotas
3. Bericht ops/reports/YYYY-MM-DD-finance-monthly.md
...
| **Cron** | `0 6 * * 1` |
| **Agenten-Dateien** | `ops/agents/ceo-kalle/*`, `ops/dashboard-data.json` (via Script) |
...
1. ops/agents/ceo-kalle/leitstand.md + ops/DEADLINES.md lesen
2. Welche Automationen laufen diese Woche? ops/reports/ — fehlen Berichte?
3. python3 scripts/build_ai_dashboard_data.py  → ops/dashboard-data.json
4. Optional Legacy: python3 scripts/generate_dashboard.py
5. Bericht ops/reports/YYYY-MM-DD-orchestrator.md
6. ops/agents/ceo-kalle/dashboard.md aktualisieren (Stand/Datum)
7. ops/LEITSTAND.md Pointer aktualisieren
